...
function App() {
  ...
  return (
    ...
    <section id="games" className="container mx-auto px-6 md:px-10 py-16 text-center">
        ...
        <button className="mt-8 border border-purple-500 text-purple-400 hover:brightness-150 px-6 py-2 rounded-full text-sm w-full md:w-auto" onClick={() => navigate(`/game`)} > VIEW MORE GAMES</button>
    </section>

    <section id="komunitas" className="container mx-auto px-6 md:px-10 py-16 text-center">
        <h2 className="text-2xl md:text-3xl font-bold mb-10">Gabung Komunitas Kami</h2>
        <div className="space-y-12 md:space-y-0 md:grid md:grid-cols-3 md:gap-12">
            <div className="flex flex-col items-center" data-aos="fade-up">
                ...
                <p className="text-gray-400 text-xs md:text-sm mt-2 px-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
             <div className="flex flex-col items-center" data-aos="fade-up">
                <div className="bg-pink-500 w-28 h-28 md:w-32 md:h-32 blob-shape flex items-center justify-center mb-4">
                    <span className="text-3xl md:text-4xl">💡</span>
