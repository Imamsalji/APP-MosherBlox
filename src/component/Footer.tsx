export default function Footer() {
    return (
        <footer className="bg-[#131122] pt-16 pb-8 border-t border-gray-800" data-aos="fade-up">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Platform game terbaik untuk melatih kecerdasan dan ketangkasan Anda dengan cara yang menyenangkan.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            <li><a href="#" className="hover:text-purple-400 transition">Explore Games</a></li>
                            <li><a href="#" className="hover:text-purple-400 transition">About Company</a></li>
                    ...
                    <div id="contact">
                        ...
                        <ul className="space-y-4 text-sm text-gray-400">
                            <li className="flex items-center space-x-3">
                                ...
                                <span>Jl. Tekno No. 12, Jakarta, Indonesia</span>
                            </li>
                            <li className="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-purple-600 transition text-white">
                            ...
                            <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-pink-600 transition text-white">
