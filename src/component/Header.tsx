...
export default function Header() {
  ...
  return (
    <header
      id="home"
      className="container header-bg mx-auto px-6 md:px-10 py-10 md:py-16 flex flex-col md:flex-row items-center text-center md:text-left"
    >
      <div className="md:w-1/2 space-y-6" data-aos="fade-up">
        ...
        <p className="text-gray-400 text-sm md:text-base max-w-md mx-auto md:mx-0">
          Dapatkan produk berkualitas dengan proses cepat, harga bersahabat, dan
          pelayanan ramah. Cocok untuk kamu yang nggak mau ribet dan ingin
          transaksi tanpa drama!
        </p>
      </div>
      <div
